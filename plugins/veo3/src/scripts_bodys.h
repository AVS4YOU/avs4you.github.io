...
const std::wstring SCRIPT_EXTEND_VIDEO = LR"([Console]::OutputEncoding = [System.Text.Encoding]::UTF8
...
function Get-Video-Mime-Type($filePath) {
...
# Input video
$inputVideoUri = "${PARAM_INPUT_VIDEO}".Trim()

$baseUrl = "https://generativelanguage.googleapis.com/v1beta"
$createUrl = "$baseUrl/models/$model`:predictLongRunning"

Write-Log "Creating Veo video job with input video..."
Write-Log "Model: $model"
Write-Log "Resolution: $resolution"
Write-Log "Input video: $inputVideoPath"

$videoMimeType = Get-Video-Mime-Type $inputVideoPath
