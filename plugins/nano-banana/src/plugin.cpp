...
CNanoBananaPlugin::CNanoBananaPlugin()
{
	...
	m_workDirectory += L"\\avs_plugin_nano_banana";
...
Plugins::PluginType CNanoBananaPlugin::Type() const
{
	return Plugins::PluginType::Content;
}

void CNanoBananaPlugin::ProcessCallback(const int& id, const NSProcesses::StreamType& type, const std::string& message)
{
	switch (type)
	{
