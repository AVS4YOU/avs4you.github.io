...
extern "C"
{
    ...
    {
        return new CStableAudio3Plugin();
    }
    void __stdcall DeletePlugin(PluginHandle p)
    {
        delete (CStableAudio3Plugin *)p;
    }
    ...
    {
        return export_str(L"StableAudio3.plugin");
    }
    wchar_t *__stdcall PluginName()
    {
        return export_str(L"Stable Audio 3");
    }
    ...
    {
        return id == AVS_AUDIO_EDITOR || id == AVS_VIDEO_CONVERTER || id == AVS_VIDEO_EDITOR;
    }
    ...
    {
        return export_str(t == Plugins::ContextType::MediaLibrary
    ...
    {
        return export_str(L"Generate audio locally with Stable Audio 3 using CPU or CUDA.");
    }
}
